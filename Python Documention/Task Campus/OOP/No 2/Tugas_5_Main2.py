...
def status_kerja_pegawai_tetap(id, nama, status_kerja, jenis_kelamin, status_menikah, jml_anak, gapok, lama_lembur, biaya_lembur_per_jam):    
    return cs.PegawaiTetap(id, nama, status_kerja, jenis_kelamin, status_menikah, jml_anak, gapok, lama_lembur, biaya_lembur_per_jam)
   
def info_pendapatan(Pegawai):  
    if isinstance(Pegawai, cs.PegawaiTetap):
